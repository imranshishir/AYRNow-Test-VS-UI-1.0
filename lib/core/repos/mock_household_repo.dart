...
class MockHouseholdRepo implements HouseholdRepo {
  ...
  @override
  Future<List<HouseholdMember>> listMembers({required String unitId}) async {
  ...
  @override
  Future<void> deactivateMember({required String memberId}) async {
