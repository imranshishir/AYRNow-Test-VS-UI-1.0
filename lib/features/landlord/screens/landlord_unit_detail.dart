          ...
          if (tenant == null)
            Card(
              child: ListTile(
                ...
                subtitle: const Text(
                    'Add tenant & create lease to start rent + maintenance tracking.'),
            ...
            Card(
              child: ListTile(
                ...
                subtitle:
                    Text('Lease ends: ${tenant.leaseEnds}\n${tenant.phone}'),
                isThreeLine: true,
                trailing: const Icon(Icons.chevron_right),
                onTap: () => Navigator.of(context)
                    .pushNamed('/landlord/tenant/detail', arguments: tenant),
              ),
            ),
          const SizedBox(height: 16),
          Text('Next',
            ...
            children: [
              Expanded(
                  child: FilledButton.tonal(
                      onPressed: () {}, child: const Text('Rent'))),
              const SizedBox(width: 12),
              Expanded(
                  child: FilledButton.tonal(
                      onPressed: () {}, child: const Text('Maintenance'))),
            ],
          ),
        ],
      ),
