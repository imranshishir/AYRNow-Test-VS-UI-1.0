...
class OperationalStaffScreen extends ConsumerWidget {
  const OperationalStaffScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Operational Staff')),
      body: ListView(
        ...
        children: [
          if (users.isEmpty)
            EmptyStateWidget(
              ...
              title: 'No staff yet',
              subtitle: 'Add security, cleaning, maintenance, or contractors.',
