...
1. Create `src/main/resources/db/migration/V<next>__description.sql`.
2. Use `IF NOT EXISTS` only where Flyway allows; prefer additive changes.
...
- Document in api-v1.md and HANDOFF.

### Step 7: README Curl Examples

1. Add curl examples to `backend/README.md` under the relevant phase section.
...
- [api-v1.md](api-v1.md) — API master spec
